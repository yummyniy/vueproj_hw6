          ...
          <div class="row">
            ...
            <div class="col-sm-8">
              ...
              <div class="mb-3">
                ...
                <textarea id="content" type="text" class="form-control" placeholder="請輸入說明內容" v-model="tempProduct.content"></textarea>
              </div>
              <div class="mb-3">
...
export default {
  ...
  mounted () {
    this.addProductModal = new Modal(this.$refs.modal, {
      keyboard: false,
      backdrop: 'static'
    })
  }
